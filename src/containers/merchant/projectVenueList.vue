  ...
  <div>
    <div>
      <el-form :inline="true" :model="form" class="demo-form-inline">
        ...
        <el-form-item>
          <router-link to="/projectVenueAdd"><el-button v-if="userInfo.userType === 3" type="primary">新增场馆</el-button></router-link>
        </el-form-item>
        <el-form-item>
      ...
      <el-table
        ...
        <el-table-column
          ...
          <template slot-scope="scope">
            ...
            <router-link v-if="userInfo.permission.includes(1) || userInfo.permission.includes(2)" :to="'/projectVenueOpeate/' + scope.row.id">
...
export default {
  ...
  methods: {
    ...
    getProjectList (params) {
      projectList({ cg: 1, ...params, areaId: this.form.cityId }).then((result) => {
