  ...
  <div>
    <div>
      <el-form :inline="true" :model="form" class="demo-form-inline">
        ...
        <el-form-item>
          <router-link to="/projectBuildingAdd"><el-button v-if="userInfo.userType === 3" type="primary">新增团建</el-button></router-link>
        </el-form-item>
        <el-form-item>
      ...
      <el-table
        ...
        <el-table-column
          ...
          <template slot-scope="scope">
            ...
            <router-link v-if="userInfo.permission.includes(1) || userInfo.permission.includes(2)" :to="'/projectBuildingOpeate/' + scope.row.id">
...
export default {
  ...
  methods: {
    ...
    getProjectList (params) {
      projectList({ cg: 2, ...params, areaId: this.form.cityId }).then((result) => {
